...
if(isset($_POST['modifier'])){
    ...
    if (validatingNomberOfChar($firstName,30) === false){
        return $ErrorNomberOfCharOfFirstName = '<span style="color:red;">Merci de siasir moin de 30 caractères </span>';
    }
    if (validatingNomberOfChar($lastName,30) === false){
        return $ErrorNomberOfCharOfLastName = '<span style="color:red;">Merci de siasir moin de 30 caractères </span>';
    }
